...
def run_random_search_for_analysis_with_logging(runs=1, generations=30, population_size=20):
    ...
    for run in range(runs):
        for generation in range(generations):
            # Generate a new random population for each generation
    ...
    best_generation_traits = {
        trait: average_traits_over_generations[trait][best_generation_index] 
        for trait in traits_data if trait != 'survival_rate'
    }
...
# Running the modified random search to collect data for analysis with logging
average_traits_data, best_generation_traits, best_generation_avg_survival_rate = run_random_search_for_analysis_with_logging(runs=10, generations=10, population_size=16)

# You can now proceed with your analysis and plotting as you have in your original code
